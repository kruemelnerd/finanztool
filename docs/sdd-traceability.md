...
- `[x]` Chart zeigt y-Achsen-Label/Ticks und Marker-Tooltip-Inhalte -> `src/test/resources/features/partials.feature`
...
- `[x]` Delete-Flow inkl. Confirm/Cancel im UI -> `src/test/resources/features/ui-delete-flows.feature`
...
- `[x]` Delete all data + Delete account inkl. Confirm/Cancel im UI -> `src/test/resources/features/ui-delete-flows.feature`
